...
{
    [HideInInspector] public float MaxReduction;
    [HideInInspector] public float MaxIncrease;
    [HideInInspector] public float RateDamping;
    [HideInInspector] public float Strength;
    [HideInInspector] public bool StopFlickering;
